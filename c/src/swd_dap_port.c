...
bool swd_dap_port_is_AP(swd_dap_port_t port) {
    return !swd_dap_port_is_DP(port);
}
...
const char* swd_dap_port_as_str(swd_dap_port_t port) {
    switch (port) {
    case DP_ABORT:     return "DP ABORT";
    case DP_IDCODE:    return "DP IDCODE";
    case DP_CTRL_STAT: return "DP CTRL_STAT";
    case DP_WCR:       return "DP WCR";
    case DP_RESEND:    return "DP RESEND";
    case DP_SELECT:    return "DP SELECT";
    case DP_RDBUFF:    return "DP RDBUFF";
    case DP_ROUTESEL:  return "DP ROUTESEL";

    case AP_CSW:   return "AP CSW";
    case AP_TAR:   return "AP TAR";
    case AP_DRW:   return "AP DRW";
    case AP_DB0:   return "AP DB0";
    case AP_DB1:   return "AP DB1";
    case AP_DB2:   return "AP DB2";
    case AP_DB3:   return "AP DB3";
    case AP_CFG:   return "AP CFG";
    case AP_BASE:  return "AP BASE";
    case AP_IDR:   return "AP IDR";
